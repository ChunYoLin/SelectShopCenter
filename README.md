...
> **目前進度**：**29 家選品店 / ~2,070 品牌 / ~94,000 商品**，涵蓋 4 種電商平台，
> 由 4 支可重用引擎驅動（每家店＝一行設定）。Next.js 前端（品牌搜尋、跨店比較、
> 庫存篩選、排序、`/brands` 品牌一覽）+ 每日 cron 自動更新。
> 跨 2 家以上選品店的品牌有 258 個，例：MARKA 8 店、COMOLI/FreshService/DAIWA PIER39 7 店、AURALEE 6 店。
